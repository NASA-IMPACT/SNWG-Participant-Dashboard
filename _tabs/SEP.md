...
<div id="overview" class="tab-content active">
    <div class="content-section">
        <h2 class="text-xl font-bold mb-4">Program Overview</h2>
...
<div id="philosophy" class="tab-content">
    <div class="content-section">
        <h2 class="text-xl font-bold mb-6">Our Engagement Philosophy</h2>
        <div class="grid-container">
            <div class="card">
                <div class="card-header">
...
<div id="lifecycle" class="tab-content">
    <div class="content-section">
        <h2 class="text-xl font-bold mb-6">Engagement Throughout the Solution Lifecycle</h2>
        <div class="space-y-6">
            <div class="card">
                <div class="card-header">
...
<div id="resources" class="tab-content">
    <div class="content-section">
        <h2 class="text-xl font-bold mb-6">Engagement Resources</h2>
        <div class="grid-container">
            <div class="card">
                <div class="card-header">
